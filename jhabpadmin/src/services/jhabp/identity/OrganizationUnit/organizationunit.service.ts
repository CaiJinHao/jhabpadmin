...
export const CreateAsyncOrganizationUnit = async (
...
export const DeleteAsyncOrganizationUnitById = async (id: string): Promise<void> => {
  return await request<void>(`${Identity_API}api/v1/OrganizationUnit`, {
    method: 'Delete',
    data: id,
  });
};
export const DeleteAsyncOrganizationUnitByKeys = async (keys: string[]): Promise<void> => {
  return await request<void>(`${Identity_API}api/v1/OrganizationUnit/keys`, {
    method: 'Delete',
    data: keys,
  });
};
export const UpdateAsyncOrganizationUnit = async (
  id: string,
...
export const UpdatePortionAsyncOrganizationUnit = async (
  id: string,
...
export const GetListAsyncOrganizationUnit = async (
...
export const GetEntitysAsyncOrganizationUnit = async (
...
export const GetAsyncOrganizationUnit = async (
  id: string,
): Promise<API.JhIdentity.OrganizationUnitDto> => {
  return await request<API.JhIdentity.OrganizationUnitDto>(
    `${Identity_API}api/v1/OrganizationUnit`,
...
export const GetRolesAsyncOrganizationUnit = async (
  id: string,
...
export const GetOrganizationTreeAsyncOrganizationUnit = async (): Promise<
  API.ListResultDto<API.JhIdentity.TreeDto>
> => {
...
export const GetMembersAsyncOrganizationUnit = async (
  id: string,
