...
const FlowItemPanel = () => (
  <ItemPanel className={styles.itemPanel}>
    <Card bordered={false}>
      ...
      />
      {/* base64是加密的svg文件，可以解密之后编辑就可以了 https://www.qqxiuzi.cn/bianma/base64.htm*/}
      <Item
        type="node"
        size="80*48"
        shape="flow-capsule"
        ...
        src="data:image/svg+xml;base64,"
      />
    </Card>
  </ItemPanel>
);
