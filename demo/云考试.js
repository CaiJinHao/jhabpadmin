      ...
      var R = {
          ...
          data: function () {
            return {
              ...
              networkQualityNum: 0,
              deviceFailAttention:
                "1. 若浏览器弹出提示，请选择“允许”<br>2. 若杀毒软件弹出提示，请选择“允许”<br>3. 检查浏览器设置，允许网页访问摄像头及麦克风<br>4. 检查摄像头/麦克风是否正确连接并开启<br>5. 尝试重新连接摄像头/麦克风<br>6. 尝试重启设备后重新检测",
          ...
          methods: {
            ...
            showDesktopRemindInfo: function () {
              ...
              k()("#browser-remind").show(),
                e.indexOf("Mac OS") > -1
                  ? k()("#remind-info").text(
                      "请使用chrome或者safari浏览器打开链接"
                    )
                  : k()("#remind-info").text("请使用chrome浏览器打开链接");
            },
            showMobileRemindInfo: function () {
              ...
              if ("iOS" === e) {
                ...
                this.isSafari ||
                  (k()("#browser-remind").show(),
                  k()("#remind-info").text(
                    "当前浏览器不支持webRTC, 请使用safari浏览器打开链接"
                  ));
              }
            },
              ...
              return this.hasCameraDevice &&
                ...
                ? this.hasCameraConnect && this.hasMicConnect
                  ...
                  : ((e = this.hasNetworkConnect
                    ...
                    e)
                : ((e = "未检测到"
                    .concat(this.hasCameraDevice ? "" : "【摄像头】")
                    .concat(this.hasVoiceDevice ? "" : "【扬声器】")
                    .concat(
                      this.hasMicDevice ? "" : "【麦克风】",
                      "设备，请检查设备连接"
                    )),
                  e);
            },
              ...
              k()("#device-testing").hide(),
                ...
                this.micTestingResult.statusResult
                  ? k()("#mic-testing-result")
                      .text("正常")
                      .css("color", "green")
                  : k()("#mic-testing-result").text("异常").css("color", "red"),
                k()("#network-name").text("网络质量"),
            ...
            handleGetUserMediaError: function (e) {
              switch (e.name) {
                ...
                case "NotAllowedError":
                  return void alert("用户/系统已拒绝授权访问摄像头或麦克风");
                case "NotFoundError":
                  return void alert("找不到摄像头或麦克风设备");
              ...
              },
              {
                ...
                value: function () {
                  (this.examId = this.$route.params.id),
                    ...
                    this.idCardLogin && (this.placeholder = "请输入身份证号"),
                    this.admissionNumLogin &&
                      (this.placeholder = "请输入准考证号"),
                    this.admissionNumLogin &&
                      this.idCardLogin &&
                      (this.placeholder = "请输入身份证号/准考证号"),
                    this.fetchData(),
                    this.isExamClient &&
                  ...
                  (a = i ? Number(i.split("/")[1].split(".")[0]) : 0),
                    ((!this.isMobile && -1 === e.indexOf("chrome")) ||
                      (!this.isMobile && a < 75)) &&
                      this.$confirm(
                        '检测到您的浏览器无法满足考试要求,请下载最新版chrome浏览器!<br/><br/> <a style="color: #02a7f0" href="https://www.google.cn/chrome/">chrome浏览器下载地址</a>',
                        "温馨提示",
                        {
                          type: "warning",
                          center: !0,
